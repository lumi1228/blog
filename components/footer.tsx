...
const socialLinks = [
  {
    label: "GitHub",
    href: "https://github.com/lumi1228",
    icon: (
    ...
    <footer className="mt-auto border-t border-[var(--border-subtle)]">
      <div className="mx-auto flex max-w-[1200px] flex-col items-center gap-4 px-6 py-8 sm:flex-row sm:justify-between">
        ...
        <p className="text-sm text-[var(--text-tertiary)]">
          ...
          <Link
            href="/"
            className="text-[var(--text-secondary)] transition-colors duration-[var(--duration-fast)] hover:text-[var(--accent-primary)]"
          >
            Lumi
          </Link>
          . All rights reserved.
          ...
          {socialLinks.map((link) => (
            <a
              ...
              className="flex h-8 w-8 items-center justify-center rounded-[var(--radius-md)]
                         text-[var(--text-tertiary)] transition-all duration-[var(--duration-fast)]
